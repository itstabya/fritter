...
class Relations {
  static async followUser(currUser, ogUser) {
    ...
    VALUES (?,
            ...
            ?,
            ?,
            ?)`, [relationType.follow, currUser, NA_FREET, ogUser, NA_FREET])
  };
  ...
  static async upvoteFreet(currUser, ogUser, ogFreetID) {
    ...
    INSERT INTO relations
      VALUES (?,
              ...
              ?,
              ?,
              ?)`, [relationType.upvote, currUser, NA_FREET, ogUser, ogFreetID])
      .then( () => { return db.run(`
        UPDATE freets
  ...
  static async refreet(currUser, ogUser, ogFreetID) {
    ...
    `INSERT INTO relations
      VALUES (?,
        ...
        ?,
        ?,
        ?)`, [relationType.refreet, currUser, newID, ogUser, ogFreetID])
      .then(() => {
